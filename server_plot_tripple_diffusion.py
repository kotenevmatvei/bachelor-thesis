"""
Due to an older Python version on the server and no easy/fast way to update, remove 
os.process_cpu_count() call from the script to determine the number of cores available
to the process
"""
